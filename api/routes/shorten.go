...
import (
	...
	"github.com/guptavishu1000/shorten-url-fiber-redis/database"
	"github.com/guptavishu1000/shorten-url-fiber-redis/helpers"
...
func ShortenURL(c *fiber.Ctx) error {
	...
	err = r.Set(database.Ctx, id, url, body.Expiry*3600*time.Second).Err()
	if err != nil {
    ...
    // Display the shortened URL on the HTML page
    return c.Render("index", fiber.Map{
        "ShortenedURL": resp.CustomShort,
    })
}